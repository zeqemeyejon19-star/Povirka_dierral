    ...
    private void addAction(NotificationCompat.Action action) {
        ...
        if (Build.VERSION.SDK_INT >= 20) {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                actionBuilder = new Notification.Action.Builder(iconCompat == null ? null : iconCompat.toIcon(), action.getTitle(), action.getActionIntent());
            } else {
                actionBuilder = new Notification.Action.Builder(action.getIcon(), action.getTitle(), action.getActionIntent());
            }
