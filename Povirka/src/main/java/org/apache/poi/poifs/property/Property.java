...
public abstract class Property implements Child, POIFSViewable {
    ...
    public Object[] getViewableArray() {
        ...
        long time2 = (time << 32) + (((long) this._seconds_1.get()) & 65535);
        long time3 = this._days_2.get();
        Object[] results = {"Name          = \"" + getName() + "\"", "Property Type = " + ((int) this._property_type.get()), "Node Color    = " + ((int) this._node_color.get()), "Time 1        = " + time2, "Time 2        = " + ((time3 << 32) + (((long) this._seconds_2.get()) & 65535)), "Size          = " + getSize()};
        return results;
    }
