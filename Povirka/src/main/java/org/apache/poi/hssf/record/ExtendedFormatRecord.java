...
public final class ExtendedFormatRecord extends StandardRecord {
    ...
    private static final BitField _reading_order = BitFieldFactory.getInstance(HSSFShapeTypes.ActionButtonInformation);
    ...
    public String toString() {
        ...
        buffer.append("          .alignment = ").append((int) getAlignment()).append("\n");
    ...
    public int hashCode() {
        int result = (1 * 31) + this.field_1_font_index;
        return (((((((((((((((result * 31) + this.field_2_format_index) * 31) + this.field_3_cell_options) * 31) + this.field_4_alignment_options) * 31) + this.field_5_indention_options) * 31) + this.field_6_border_options) * 31) + this.field_7_palette_options) * 31) + this.field_8_adtl_palette_options) * 31) + this.field_9_fill_palette_options;
    }
