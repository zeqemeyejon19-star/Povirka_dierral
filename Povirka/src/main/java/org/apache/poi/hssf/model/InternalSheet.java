...
public final class InternalSheet {
    ...
    private InternalSheet(RecordStream rs) {
        ...
        if (this._dimensions == null) {
            ...
            DimensionsRecord dimensionsRecordCreateDimensions = rra.createDimensions();
            this._dimensions = dimensionsRecordCreateDimensions;
            records.add(dimsloc, dimensionsRecordCreateDimensions);
        }
        if (rra == null) {
            rra = new RowRecordsAggregate();
    ...
    private InternalSheet() {
        ...
        records.add(printHeadersRecordCreatePrintHeaders);
        ...
        records.add(defaultRowHeightRecordCreateDefaultRowHeight);
        ...
        records.add(selectionRecordCreateSelection);
