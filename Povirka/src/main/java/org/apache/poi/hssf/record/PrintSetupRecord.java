...
public final class PrintSetupRecord extends StandardRecord {
    ...
    public String toString() {
        ...
        buffer.append("    .papersize      = ").append((int) getPaperSize()).append("\n");
        buffer.append("    .scale          = ").append((int) getScale()).append("\n");
        buffer.append("    .pagestart      = ").append((int) getPageStart()).append("\n");
        buffer.append("    .fitwidth       = ").append((int) getFitWidth()).append("\n");
        buffer.append("    .fitheight      = ").append((int) getFitHeight()).append("\n");
        ...
        buffer.append("    .hresolution    = ").append((int) getHResolution()).append("\n");
        buffer.append("    .vresolution    = ").append((int) getVResolution()).append("\n");
        buffer.append("    .headermargin   = ").append(getHeaderMargin()).append("\n");
        buffer.append("    .footermargin   = ").append(getFooterMargin()).append("\n");
        buffer.append("    .copies         = ").append((int) getCopies()).append("\n");
        buffer.append("[/PRINTSETUP]\n");
