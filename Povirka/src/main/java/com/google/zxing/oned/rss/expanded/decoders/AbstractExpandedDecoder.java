...
public abstract class AbstractExpandedDecoder {
    ...
    public static AbstractExpandedDecoder createDecoder(BitArray information) {
        ...
        if (information.get(2)) {
            int iExtractNumericValueFromBitArray = GeneralAppIdDecoder.extractNumericValueFromBitArray(information, 1, 4);
            ...
            int iExtractNumericValueFromBitArray2 = GeneralAppIdDecoder.extractNumericValueFromBitArray(information, 1, 5);
