...
final class DecodedBitStreamParser {
    ...
    /* JADX WARN: Removed duplicated region for block: B:57:0x00eb A[LOOP:0: B:67:0x001c->B:57:0x00eb, LOOP_END] */
    ...
    */
    ...
    private static void decodeKanjiSegment(BitSource bitSource, StringBuilder sb, int i) throws FormatException {
        ...
        while (i > 0) {
            int bits = bitSource.readBits(13);
            int i4 = (bits % HSSFShapeTypes.ActionButtonInformation) | ((bits / HSSFShapeTypes.ActionButtonInformation) << 8);
            if (i4 < 7936) {
                i2 = 33088;
            } else {
                i2 = 49472;
    ...
    private static int parseECIValue(BitSource bits) throws FormatException {
        ...
        if ((firstByte & HSSFShapeTypes.ActionButtonInformation) == 128) {
