...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (dimensionTop3 * 4 >= dimensionRight3 * 7 || dimensionRight3 * 4 >= dimensionTop3 * 7) {
            ResultPoint topRight2 = topRight;
            ResultPoint pointD2 = bottomLeft3;
            bottomRight = bottomRight2;
            ResultPoint topLeft2 = pointD2;
            c = 3;
            ResultPoint resultPointCorrectTopRightRectangular = correctTopRightRectangular(bottomLeft2, bottomRight2, pointD2, topRight2, dimensionTop3, dimensionRight3);
            correctedTopRight = resultPointCorrectTopRightRectangular;
        ...
        ResultPoint resultPointCorrectTopRight = correctTopRight(bottomLeft2, bottomRight2, bottomLeft3, topRight3, dimension);
        correctedTopRight = resultPointCorrectTopRight;
